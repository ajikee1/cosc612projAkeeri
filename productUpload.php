...
function uploadProduct($servername, $username, $password, $db)
{
    ...
    if (isset($_POST['uploadProductDB'])) {
...
<form method="post" action="productUpload.php" enctype="multipart/form-data">
    ...
    Product description: <textarea name="productDescription" rows="10" cols="10"
                                   placeholder="Enter product details here..."></textarea>
    <button type="submit" name="uploadProductDB">Add product</button>
